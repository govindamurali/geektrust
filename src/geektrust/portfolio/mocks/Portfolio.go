...
func (_m *Portfolio) Allocate(allocation portfolio.Allocation) error {
	ret := _m.Called(allocation)

	var r0 error
	if rf, ok := ret.Get(0).(func(portfolio.Allocation) error); ok {
		r0 = rf(allocation)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *Portfolio) GetBalance(month enum.Month) (portfolio.Allocation, error) {
	ret := _m.Called(month)

	var r0 portfolio.Allocation
	if rf, ok := ret.Get(0).(func(enum.Month) portfolio.Allocation); ok {
		r0 = rf(month)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(portfolio.Allocation)
		}
	}
...
func (_m *Portfolio) GetLastRebalance() (portfolio.Allocation, error) {
	ret := _m.Called()

	var r0 portfolio.Allocation
	if rf, ok := ret.Get(0).(func() portfolio.Allocation); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(portfolio.Allocation)
...
func (_m *Portfolio) StartSip(sip portfolio.Allocation) {
	_m.Called(sip)
}

// NewPortfolio creates a new instance of Portfolio. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewPortfolio(t testing.TB) *Portfolio {
	mock := &Portfolio{}
	mock.Mock.Test(t)
